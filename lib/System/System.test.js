...
describe('constructor', function () {
  ...
  test('registers all passed event handlers', function () {
    var eventHandlers = {
      engineConstructed: jest.fn(),
      testEvent: jest.fn()
    };
    var system = new _index2.default(undefined, eventHandlers);
    var engine = new _Engine2.default(undefined, [system]);
...
describe('onEngineConstructed', function () {
  test('engine is registered', function () {
    var system = new _index2.default();
    var engine = new _Engine2.default(undefined, [system]);
    expect(system.engine).toBeDefined();
  });

  test('cannot be registered to two engines simultaneously', function () {
    expect(function () {
      var system = new _index2.default();
      var engineA = new _Engine2.default(undefined, [system]);
      var engineB = new _Engine2.default(undefined, [system]);
    }).toThrow();
  });
});