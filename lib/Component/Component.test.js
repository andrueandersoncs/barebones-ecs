...
describe('isValidComponentType', function () {
  test('returns true if passed valid component type', function () {
    expect(_Component2.default.isValidComponentType('testComponent')).toBe(true);
  });

  test('returns false if passed anything other than valid component type', function () {
    expect(_Component2.default.isValidComponentType({})).toBe(false);
    expect(_Component2.default.isValidComponentType(1234)).toBe(false);
    expect(_Component2.default.isValidComponentType(false)).toBe(false);
    expect(_Component2.default.isValidComponentType([])).toBe(false);
  });
});